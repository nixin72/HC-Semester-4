...
namespace HulkHvkDB {
    public class ReservationDB {
        ...
        //        public DataTable GetFullActiveReservationInfo() {
        //            dsHvkTableAdapters.ReservationInformationTableAdapter adapter = new dsHvkTableAdapters.ReservationInformationTableAdapter();
        //            adapter.ClearBeforeFill = true;
        //            return adapter.GetActiveReservations();
        //        }

        //        public dsHvk.ReservationInformationDataTable GetActiveReservationInfoByOwnerNumber(int ownerNumber) {
        //            dsHvkTableAdapters.ReservationInformationTableAdapter adapter = new dsHvkTableAdapters.ReservationInformationTableAdapter();
        //            adapter.ClearBeforeFill = true;
        //            return adapter.GetActiveReservationsByOwnerNumber(ownerNumber);
        //        }
        //
        //        public dsHvk.ReservationInformationDataTable GetUpcomingReservationInfo(DateTime date) {
        //            dsHvkTableAdapters.ReservationInformationTableAdapter adapter = new dsHvkTableAdapters.ReservationInformationTableAdapter();
        //            adapter.ClearBeforeFill = true;
        //            return adapter.GetDataByUpcomingReservations(date);
        //        }
    }
}

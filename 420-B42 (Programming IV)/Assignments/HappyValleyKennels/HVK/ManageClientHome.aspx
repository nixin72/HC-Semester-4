<%@ Page Title="" Language="C#" MasterPageFile="~/HVK.Master" AutoEventWireup="true" CodeBehind="ManageClientHome.aspx.cs" Inherits="HVK.ManageClientHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageTitle" runat="server">
    <h2>
        <asp:Label runat="server" ID="lblPageTitle">Manage Client Home</asp:Label></h2>
</asp:Content>
            ...
            <div runat="server" id="homeLeftPanel" style="border: thin solid black; width: 40%">
                ...
                <div id="customerInfo" class="flex-container" style="display: flex;">
                    ...
                    <div class="info">
                        ...
                        <br />
                        <asp:LinkButton ID="editCusLink" runat="server" Font-Underline="True" ForeColor="Blue">Edit</asp:LinkButton>
                    </div>
                </div>
